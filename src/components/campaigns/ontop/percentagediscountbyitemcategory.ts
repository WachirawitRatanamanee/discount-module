...
document.addEventListener("DOMContentLoaded", () => {
  const checkBoxPrimary = <HTMLInputElement>document.getElementById("percentage-discount-by-item-category");
  const checkBoxSecondary = <HTMLInputElement>document.getElementById("discount-by-points");
