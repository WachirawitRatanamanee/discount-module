...
document.addEventListener("DOMContentLoaded", () => {
  const checkBoxPrimary = <HTMLInputElement>document.getElementById("fixed-amount");
  const checkBoxSecondary = <HTMLInputElement>document.getElementById("percentage-discount");
