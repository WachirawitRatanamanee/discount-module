...
document.addEventListener("DOMContentLoaded", () => {
  const checkBoxPrimary = <HTMLInputElement>document.getElementById("percentage-discount");
  const checkBoxSecondary = <HTMLInputElement>document.getElementById("fixed-amount");
